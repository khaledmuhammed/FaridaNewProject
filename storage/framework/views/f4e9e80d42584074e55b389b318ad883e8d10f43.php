<?php $__env->startSection('adminlte_css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(mix('/css/dashboard/dashboard.css')); ?>">
    <?php if(app()->isLocale('ar')): ?>
        <link rel="stylesheet" href="<?php echo e(mix('css/dashboard/dashboard-rtl.css')); ?>">
    <?php endif; ?>
            ...
            <?php if(config('adminlte.layout') == 'top-nav'): ?>
                ...
                <!-- Content Header (Page header) -->
                    ...
                    <section class="content">
                        <?php if($errors->any()): ?>
                            <?php $__currentLoopData = $errors->get('error'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
