        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="print text-center col-sm-6">
                        <button onclick="window.print()" class="btn btn-secondary btn-block">
                            <span class="glyphicon glyphicon-print"></span>
                            طباعة
                        </button>
                    </div>
                    <div class="print text-center col-sm-6 download-pdf">
                        <a href="{{route('order.pdfDownload', $order->id)}}" class="btn btn-secondary btn-block">
