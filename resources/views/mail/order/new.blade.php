    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              <b>{{$order->username}},</b> @lang('Thank you for ordering from') @lang('Faridah Flowers') !
            </td>
          </tr>
          <tr>
            <td class="free-text">
              @lang('Your order has been successfully completed,') @lang('Order ID') <a href="">#{{$order->id}}</a>. @lang('Below you will find your order details').
            </td>
          </tr>
          <tr>
            <td class="button">
