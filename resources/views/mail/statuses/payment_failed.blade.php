                ...
                <tr>
                    <td>
                        ...
                        <div>
                            ...
                            <br/>
                            <p>@lang('We apologize, there is an error in your attempt to complete the payment, please go to the Orders page and try your payment again. You do not need to re-order again') .</p>
                            <br/>
                        </div>
