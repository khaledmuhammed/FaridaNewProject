    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-info ">
                ...
                <!-- form start -->
                {!! Form::open(['action' => ['Admin\PageController@update', $page->id],'class'=>'form-horizontal','method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
                {{csrf_field()}}
                <div class="box-body">
                    ...
                    <div class="form-group {{$errors->first('title_ar') ? 'has-error' :  ''}}">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_ar', $page->title_ar, ['class' => 'form-control','required'=>'required']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="content_ar" name="content_ar">{!! $page->content_ar !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('is_active', __('Is Show?'), ['class' => 'control-label col-sm-2']) !!}
                        <div class="col-sm-10">
                            <toggler name="is_active" :old="{{$page->is_active}}"></toggler>
                        </div>
                    </div>
